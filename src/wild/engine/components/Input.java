...
public class Input {
    ...
    private static int[] keydbl = new int[NUM_KEYCODES];
    ...
    public static boolean getKeyDownDbl(int keyCode)
    {
          if (getKeyDown(keyCode))
        	  return getDoubleClick(keyCode);
          return false;
    }
    
    private static boolean getDoubleClick(int keycode) {
    	keydbl[keycode]++;
    	if (keydbl[keycode] >= 2) {
    		keydbl[keycode] = 0;
    		return true;
