...
public class Model {
	private final List<Vec3> vertices = new ArrayList<Vec3>();
    private final List<Vec2> textureCoordinates = new ArrayList<Vec2>();
    private final List<Vec3> normals = new ArrayList<Vec3>();
    ...
    public List<Vec2> getTextureCoordinates() {
