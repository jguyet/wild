package wild.engine.components.shape.obj;
...
public class OBJLoader {
	public static int createDisplayList(Model m) {
        ...
        glNewList(displayList, GL_COMPILE);
        {
            ...
            for (Model.Face face : m.getFaces()) {
                if (face.hasNormals()) {
                    Vec3 n1 = m.getNormals().get(face.getNormalIndices()[0] - 1);
                    glNormal3f(n1.x, n1.y, n1.z);
                }
                Vec3 v1 = m.getVertices().get(face.getVertexIndices()[0] - 1);
                glVertex3f(v1.x, v1.y, v1.z);
                if (face.hasNormals()) {
                    Vec3 n2 = m.getNormals().get(face.getNormalIndices()[1] - 1);
                    glNormal3f(n2.x, n2.y, n2.z);
                }
                Vec3 v2 = m.getVertices().get(face.getVertexIndices()[1] - 1);
                glVertex3f(v2.x, v2.y, v2.z);
                if (face.hasNormals()) {
                    Vec3 n3 = m.getNormals().get(face.getNormalIndices()[2] - 1);
                    glNormal3f(n3.x, n3.y, n3.z);
                }
                Vec3 v3 = m.getVertices().get(face.getVertexIndices()[2] - 1);
    ...
    private static float[] asFloats(Vec3 v) {
    ...
    public static int createTexturedDisplayList(Model m) {
        ...
        glNewList(displayList, GL_COMPILE);
        {
            ...
            for (Model.Face face : m.getFaces()) {
                ...
                if (face.hasTextureCoordinates()) {
                    Vec2 t1 = m.getTextureCoordinates().get(face.getTextureCoordinateIndices()[0] - 1);
                ...
                if (face.hasTextureCoordinates()) {
                    Vec2 t2 = m.getTextureCoordinates().get(face.getTextureCoordinateIndices()[1] - 1);
                ...
                if (face.hasTextureCoordinates()) {
                    Vec2 t3 = m.getTextureCoordinates().get(face.getTextureCoordinateIndices()[2] - 1);
    ...
    public static Model loadTexturedModel(File f) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (line.startsWith("mtllib ")) {
                ...
                m.getTextureCoordinates().add(new Vec2(s, t));
